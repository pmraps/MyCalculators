...
begin
  ...
  InitializeCaptions;
  // Avoid button captions in translation .po files
  ReturnToSimplePanel;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '7'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '7';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + ' ' + Operators + ' ';
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '8'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '8';
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '9'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '9';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '4'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '4';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '5'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '5';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '6'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '6';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '1'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '1';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '2'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '2';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '3'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '3';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then txtFieldResult.Text := '0'
    ...
    txtFieldResult.Text := txtFieldResult.Text + '0';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  if txtFieldResult.Text = '' then
    ...
    txtFieldResult.Text := txtFieldResult.Text + ',';
  stTxtBreadcrumbs.Caption := stTxtBreadcrumbs.Caption + txtFieldResult.Text;
end;
...
begin
  ...
  begin
    ...
    case Operators of
      ...
      'D>N': CalculatorEquals :=
          StrToFloat(baseToBase(Num1, 10, StrToInt(Num2)));
      'B>N': CalculatorEquals :=
          StrToFloat(baseToBase(Num1, 2, StrToInt(Num2)));
      'O>N': CalculatorEquals :=
          StrToFloat(baseToBase(Num1, 8, StrToInt(Num2)));
      'H>N': CalculatorEquals :=
          StrToFloat(baseToBase(Num1, 16, StrToInt(Num2)));
      'NRoot': CalculatorEquals := Power(Number1, (1 / Number2));
      'Log': CalculatorEquals := LogN(Number2, Number1);
      'Exp': if Number1 >= 0 then
          CalculatorEquals := Power(Number1, Number2)
        else
        begin
...
begin
  StTxtDateCalculation.Caption :=
    DateDifference(dtEditStartDate.Date, dtEditEndDate.Date);
end;
...
begin
  ...
  SetDefaultLang(po);
  // Translate resource strings and insert them into the current form
  UpdateTranslation(po);    // Inserts translated strings into the other forms
  frmMyCalculators.CurrentLang := po;
end;
...
begin
  ...
  try
    ...
    FindAllFiles(LanguageList, Application.Location + 'languages',
      FileName + '.*.po', False);
