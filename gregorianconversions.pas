...
begin
  ...
  A := (14 - GMonth) div 12;
  B := GYear + 4800 - A;
  JDN := GDay + ((153 * (GMonth + 12 * A - 3) + 2) div 5) + (365 * B) +
    (B div 4) - (B div 100) + (B div 400) - 32045;
...
begin
  ...
  MonthsElapsed := 235 * ((Year - 1) div 19) + 12 * ((Year - 1) mod 19) +
    (((Year - 1) mod 19) * 7 + 1) div 19;
...
begin
  A := (14 - Month) div 12;
  B := Year + 4800 - A;
  Result := Day + (153 * (Month + 12 * A - 3) + 2) div 5 + 365 *
    B + B div 4 - B div 100 + B div 400 - 32045;
end;
