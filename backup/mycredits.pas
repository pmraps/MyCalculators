...
type
  ...
  TfrmCredits = class(TLocalizedForm)
    ...
    StTxtCreditsDarkTheme: TStaticText;
    ...
    procedure StTxtCreditsDarkThemeClick(Sender: TObject);
    procedure StTxtCreditsDarkThemeMouseEnter(Sender: TObject);
...
procedure TfrmCredits.StTxtCreditsDarkThemeClick(Sender: TObject);
begin
  OpenURL('https://icy.lt/post/lazarus-ide-and-your-program-in-dark-mode-on-microsoft-windows/');
end;

procedure TfrmCredits.StTxtCreditsDarkThemeMouseEnter(Sender: TObject);
begin
  StTxtCreditsDarkTheme.Cursor := crHandPoint;
end;
